	...
	public static int inputInt() {
		while (true) {
			try {
				...
				System.err.println("Không thể nhập chữ hoặc kí tự đặc biệt. Mời nhập lại");
			}
		}
	}
	...
	public static LocalDate inputLocalDate() {
		...
		while (true) {
			...
			try {
				...
				System.err.println("Mời nhập theo đúng định dạng: yyyy-MM-dd");
			}
		}
	}
	...
	public static String inputString() {
		while (true) {
			...
			if (!input.isEmpty()) {
				...
				System.err.println("Không được bỏ trống, mời nhập lại");
			}
		}
	}
